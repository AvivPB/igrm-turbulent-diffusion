    ...
    for target_snap_num in args.target_snap_nums:
        ...
        for source_halo_id in args.source_halo_ids:
            ...
            with open(args.output_file, 'a') as f:                    
                ...
                output = f'{args.caesar_dir}\t{source_snap_num}\t{z_source}\t{source_halo_id}\t{source_halo.virial_quantities['m500c']}\t{source_halo.contamination}\t{target_snap_num}\t{z_target}'
