    ...
    with h5py.File(args.output_file, 'r+') as f:
        ...
        for halo_type, halo in zip(halo_types, halos):
            ...
            try:
                ...
                append_to_dataset(group, 'ngas', np.nan, curr_length)
            ...
            try:
                ...
                append_to_dataset(group, 'nstar', np.nan, curr_length)
            ...
            try:
                ...
                append_to_dataset(group, 'nbh', np.nan, curr_length)
            ...
            try:
                ...
                append_to_dataset(group, 'ndm', np.nan, curr_length)


            aperture_names = ['30ckpc', '50ckpc'] + [f'r{delta_value}c' for delta_value in delta_values]
            apertures = [target_snap.arr(30, 'kpccm'), target_snap.arr(50, 'kpccm')] + [halo.virial_quantities[f'r{delta_value}c'].in_units('kpccm') for delta_value in delta_values]
            for aperture, aperture_name in zip(apertures, aperture_names):
                sphere = target_snap.sphere(halo.minpotpos, aperture)
                for part_type in part_types:
                    ...
                    if part_type == 'PartType5':
                        create_dataset(group, f'n{part_type}_with_jets_{aperture_name}', dtype='f8', units='1')
                        ...
                        try:
                            ...
                            # Find BHs with Mbh,phys >= Mbh,jet,min (4e7 Msun for Simba, 7e7 Msun for Simba-C)
                            # and f_edd <= f_edd,jet,max (0.2)
                            bh_mass_jet_min = target_snap.arr(7e7, 'Msun')
                            bh_fedd_jet_max = target_snap.arr(0.2, '1')
                            bh_filter = np.where(np.logical_and(bh_mass >= bh_mass_jet_min, bh_fedd <= bh_fedd_jet_max))[0]
                            print('\nbh_filter:')
                            print(bh_filter)
                            # print(bh_filter[0])
                            print()
                            ...
                            append_to_dataset(group, f'n{part_type}_with_jets_{aperture_name}', npart, curr_length)
                        except Exception as error:
                            print(f'Bad {halo_type} n{part_type}_with_jets_{aperture_name}')
                            print(error)
                            print()
                            append_to_dataset(group, f'n{part_type}_with_jets_{aperture_name}', np.nan, curr_length)
            ...
            try:
                ...
                append_to_dataset(group, 'sfr', 0*units.Msun/units.yr, curr_length)
            ...
            try:
                ...
                append_to_dataset(group, 'sfr_100', 0*units.Msun/units.yr, curr_length)
            ...
            for mass_type in halo_mass_types:
                ...
                try:
                    ...
                    append_to_dataset(group, f'{mass_type}_mass', 0*units.Msun, curr_length)
            ...
            for radii_type in halo_radii_types:
                for XX in halo_radii_XX:
                    ...
                    try:
                        ...
                        append_to_dataset(group, f'{radii_type}_{XX}_radius', np.nan*units.kpc, curr_length)
                    ...
                    try:
                        ...
                        # prop_dict[halo_type][f'{radii_type}_{XX}_radius'].append(unyt.unyt_array(np.nan, 'kpc'))
                        append_to_dataset(group, f'{radii_type}_{XX}_radius_cm', np.nan*units.kpccm, curr_length)
            ...
            for vel_disp_type in halo_velocity_dispersion_types:
                ...
                try:
                    ...
                    append_to_dataset(group, f'{vel_disp_type}_velocity_dispersion', np.nan*units.km/units.s, curr_length)
                ...
                try:
                    ...
                    # prop_dict[halo_type][f'{vel_disp_type}_velocity_dispersion'].append(unyt.unyt_array(np.nan, 'km/s'))
                    append_to_dataset(group, f'{vel_disp_type}_velocity_dispersion_cm', np.nan*units.kmcm/units.s, curr_length)
            ...
            for age_type in halo_age_types:
                ...
                try:
                    ...
                    append_to_dataset(group, f'{age_type}_stellar_age', np.nan*units.Gyr, curr_length)
            ...
            for temp_type in halo_temperature_types:
                ...
                try:
                    ...
                    append_to_dataset(group, f'{temp_type}_temperature', np.nan*units.K, curr_length)
            ...
            for dens_type in halo_local_density_types:
                ...
                try:
                    ...
                    append_to_dataset(group, f'local_mass_density_{dens_type}kpccm', np.nan*units.Msun/units.kpccm**3, curr_length)
                ...
                try:
                    ...
                    append_to_dataset(group, f'local_number_density_{dens_type}kpccm', np.nan*units.kpccm**-3, curr_length)
        ...
        for central_type, central in zip(central_types, centrals):
            ...
            try:
                ...
                append_to_dataset(group, 'bh_mdot', np.nan*units.Msun/units.yr, curr_length)
            ...
            try:
                ...
                append_to_dataset(group, 'bh_fedd', np.nan, curr_length)
        ...
        ## dynamically deallocate variables to free up memory
        del target_snap, target_obj, halo_progens, gal_progens, first_mmp_halo, second_mmp_halo, first_mmp_halo_central, second_mmp_halo_central, first_mmp_central, second_mmp_central, first_mmp_central_halo, second_mmp_central_halo
        gc.collect()
